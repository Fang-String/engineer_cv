...
def batch_process_images(folder_path, output_folder, predictor):
    ...
    for filename in sorted(os.listdir(folder_path)):
        if filename.endswith(".png"):
            ...
            mask_imagea, mask_imageb = process_image(image_path, predictor)
...
# 设置输入文件夹和输出文件夹
input_folder = "/home/ubuntu/Ubuntu/sam_4_eng/images"  # 输入图片文件夹
output_folder = "/home/ubuntu/Ubuntu/sam_4_eng/masks"  # 输出掩码文件夹
