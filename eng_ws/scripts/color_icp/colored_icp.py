...
if __name__ == "__main__":
    ...
    # load point clouds
    source = o3d.io.read_point_cloud("/home/ubuntu/tools/color_icp/data/cloud_bin_00_easy.pcd")
    target = o3d.io.read_point_cloud("/home/ubuntu/tools/color_icp/data/cloud_bin_00.pcd")
